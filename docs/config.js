// Configuration for California Snow Conditions Map
...
// Map configuration
const MAP_CONFIG = {
    // California ski resort bounds (tightly focused on mountain areas)
    bounds: [
        [-120.5, 34.0],  // Southwest (SoCal resorts)
        [-118.8, 41.6]   // Northeast (Mt. Shasta area)
    ],
    padding: {
        top: 50,
        bottom: 50,
